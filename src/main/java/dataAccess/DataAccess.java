...
import modelo.modelo.HibernateUtil;
...
public class DataAccess {
	...
	public Event getEvent(Event e) {
		...
		Query q = session.createQuery("from Event e where e.eventNumber=:ev");
	...
	public List<Event> getEvents(Date date) {
		...
		session.beginTransaction();
		Query query = session.createQuery("SELECT ev FROM Event ev WHERE ev.eventDate=:e");   
	...
	public List<Date> getEventsMonth(Date date) {
		...
		session.beginTransaction();
		Query query = session.createQuery("SELECT DISTINCT ev.eventDate FROM Event ev WHERE ev.eventDate BETWEEN '"+firstDayMonthDate+"' and '"+lastDayMonthDate+"'");   
